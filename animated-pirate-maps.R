# Description : Animated pirate attacks with maps
# Website : http://rud.is/b/2013/09/19/animated-irl-pirate-attacks-in-r/

doInstall <- TRUE # Change to FALSE if you don't want packages installed.
toInstall <- c("maps","hexbin","ggplot2","maptools","sp","mapproj")
