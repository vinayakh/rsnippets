# Description : A simulation and plot of the Metropolis Algortihm
# Website : http://mbjoseph.github.io/blog/2013/09/08/metropolis/
# Notes : This script requires imagemagick to be installed for using the convert command
