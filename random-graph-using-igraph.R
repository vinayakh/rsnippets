# Description : File generates random graph with random dates and creates set of pngs for animation
# Website : http://somelab.net/2012/11/how-to-create-a-network-animation-with-r-and-the-igraph-package/
...
for (time.step in 1:num.time.steps) {
  ...
  out.file.name <- paste("/home/vinayak/netanim_", time.step, ".png", sep="")
